...
extern FLAC_file_list flac_files;
...
void update_track_display(void)
{
    ...
    lcd16x2_i2c_printf("                ");
    lcd16x2_i2c_set_cursor(0, 0);
    display_text(flac_files.filenames[flac_files.current_index]);
}
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
        ...
        if (Appli_state == APPLICATION_READY)
        {
            ...
            flac_player_file_select(flac_files.filenames[flac_files.current_index]);
            flac_player_play();

            while (!flac_player_is_finished())
            {
                flac_player_process();
